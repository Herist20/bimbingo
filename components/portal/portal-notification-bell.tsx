...
function notifText(n: NotifRow): {
  ...
  switch (n.type) {
    case 'milestone_comment':
      return {
        title: `Balasan baru di ${String(p.milestone_title ?? 'milestone')}`,
        description:
          p.by_role === 'admin'
            ? 'Pembimbing mengirim komentar.'
            : 'Klien mengirim komentar.',
        href: `/portal/proyek/${projectId}#m-${milestoneId}`,
      };
    ...
    default:
      return { title: 'Notifikasi', description: '', href: '/portal' };
  }
}
